...
public class Keyword {
	...
	/**
	 * This method return driver instance Make sure before calling this method one
	 * should call {@code openBrowser(String browseName)} so that driver instance
	 * get initiated.
	 */
	...
	/**
	 * This method searches element in page with locatorType and locator
	 *
	...
	/**
	 * If a new tab is opened by click action driver need to be switched to it.
	 */
